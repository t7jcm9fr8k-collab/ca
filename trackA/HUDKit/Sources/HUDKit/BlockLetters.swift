...
public struct BlockLetters: View {
    ...
    /// Extrusion depth. 1:1 with `cell` is the shipped setting.
...
public enum Glyphs {
    /// The full alphabet: A-Z, 0-9 and space.
    ///
    /// **Complete on purpose.** An earlier version carried only the fifteen
    /// letters some particular word happened to need. A partial table is not a
    /// neutral limitation — the set itself says which letters were wanted, and
    /// any word outside it renders as gaps, which a caller discovers only after
    /// typing their own name into it. Keys are in alphabetical then numeric
    /// order, which carries no information; do not re-sort them into the order
    /// of any word.
    ///
    /// Zero is a cell narrower than O so the two never read alike.
    public static let table: [Character: [String]] = [
        "A": ["011110", "111111", "110011", "111111", "111111", "110011", "110011"],
        "B": ["111110", "111111", "110011", "111110", "110011", "111111", "111110"],
        ...
        "G": ["011110", "111111", "110000", "110111", "110011", "111111", "011110"],
        "H": ["110011", "110011", "110011", "111111", "111111", "110011", "110011"],
        "I": ["111111", "111111", "001100", "001100", "001100", "111111", "111111"],
        "J": ["001111", "001111", "000011", "000011", "110011", "111111", "011110"],
        ...
        "Q": ["011110", "111111", "110011", "110011", "110111", "111111", "011111"],
        ...
        "V": ["110011", "110011", "110011", "110011", "011110", "011110", "001100"],
        ...
        "Z": ["111111", "111111", "000110", "001100", "011000", "111111", "111111"],
        "0": ["01110", "11111", "11011", "11011", "11011", "11111", "01110"],
        "1": ["001100", "011100", "111100", "001100", "001100", "111111", "111111"],
        "2": ["011110", "111111", "000011", "000110", "011000", "111111", "111111"],
        "3": ["111110", "111111", "000011", "001110", "000011", "111111", "111110"],
        "4": ["000110", "001110", "011110", "110110", "111111", "111111", "000110"],
        "5": ["111111", "111111", "110000", "111110", "000011", "111111", "111110"],
        "6": ["011110", "111111", "110000", "111110", "110011", "111111", "011110"],
        "7": ["111111", "111111", "000011", "000110", "001100", "001100", "001100"],
        "8": ["011110", "111111", "110011", "011110", "110011", "111111", "011110"],
        "9": ["011110", "111111", "110011", "011111", "000011", "111111", "011110"],
